...
private struct InterfaceSettingsView: View {
    ...
    // SevenThemes palettes (fallbacks provided if assets missing)
    private let paletteOptions: [(style: AppThemeStyle, label: String)] = [
        (.aqua, "Aqua"), (.cobalt, "Cobalt"), (.cocoa, "Cocoa"),
        (.forest, "Forest"), (.indigo, "Indigo"), (.saffron, "Saffron"), (.teal, "Teal")
    ]
    ...
    var body: some View {
        ...
        Form {
            ...
            Section("Font") {
                ...
                .animation(.easeInOut(duration: 0.2), value: store.interfaceFontStyle)
